    ...
    <div class="col-lg-4">
        <a href="#">
            <div class="overflow-hidden">
                <img class="landingIMG-motocycles" src="/images/Moto4.png">
            </div>
        </a> 
    </div>
    <div class="col-lg-4">
        <a href="#">
            <div class="overflow-hidden">
                <img class="landingIMG-motocycles" src="/images/Moto5.png">
            </div>
        </a>
    </div>
    <div class="col-lg-4">
        <a href="#">
            <div class="overflow-hidden">
                <img class="landingIMG-motocycles" src="/images/Moto8.png" class="moto8">
            </div>
        </a>
    </div>
</div>
